...
sns.regplot(data=python_without_timeout, x="optimized", y="python", ci = None)
...
sns.regplot(data=python_without_timeout, x="prolog", y="python", ci = None)

ax3.set_xlim(left=0,right=3600)
ax3.set_ylim(bottom = 0, top=3600)

ax3.plot(ax4.get_xlim(), ax4.get_ylim(), linestyle='--')
...
sns.regplot(data=python_without_timeout, x="prolog", y="optimized", ci = None)

ax2.set_xlim(left=0,right=3600)
ax2.set_ylim(bottom = 0, top=3600)

ax2.plot(ax4.get_xlim(), ax4.get_ylim(), linestyle='--')
...
ax.plot(ax4.get_xlim(), ax4.get_ylim(), linestyle='--')
